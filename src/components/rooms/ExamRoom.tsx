...
import { useGameStore, Exam } from '@/store/gameStore';
...
import { GraduationCap, Plus, Calendar, Clock, Trash2, Edit2, Check, X } from 'lucide-react';
import { toast } from 'sonner';

export const ExamRoom = () => {
  const { exams, addExam, updateExam, deleteExam } = useGameStore();
  ...
  const handleStartEdit = (exam: Exam) => {
    ...
    setEditValues({ name: exam.name, startDate: exam.startDate });
  };
                    ...
                    {isEditing ? (
                      <div className="space-y-3">
                        ...
                        <div className="flex gap-2">
                          <PixelButton size="sm" onClick={() => handleSaveEdit(exam.id)}>
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2 mt-1">
                              ...
                              <span className="font-game text-lg text-primary-foreground/80">
                                {new Date(exam.startDate).toLocaleDateString('en', {
                                  weekday: 'short',
                                  month: 'short',
                                  day: 'numeric',
                                  year: 'numeric',
              ...
              <PixelPanel variant="dialog">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2 pt-2">
                    <PixelButton onClick={handleAddExam} className="flex-1">
                      Add Exam
                    </PixelButton>
                    <PixelButton
                      variant="secondary"
